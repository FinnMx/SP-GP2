...
<body>
    ...
    <a href="projectengineeroverview.php">Project and Engineer performance</a>
    ...
    <div class="container">
        ...
        <form action="includes/assign_group.inc.php" method="post">
            <div>
                ...
                ?>
                <option value="<?php echo $arrayResult[$i]['Group_ID']?>"><?php echo $arrayResult[$i]['Group_ID']?></option>
                <?php endfor;?>
                <br>
                <label class="label">Project ID:</label>
                <br>
