...
if (isset($_POST['submit'])){
    CreateProject($_POST['project_id'], $_POST['project_name'], $_POST['project_value'], 0, $_POST['material_cost'], $_POST['additional_cost'], $_POST['comments'], 0, "Active");
}
...
function CreateProject($ProjectID, $ProjectName, $ProjectVal, $EngineerCost, $MaterialCost, $AdditionalCost, $Comments, $CustomerSatisfaction, $Status){
    ...
    $sql = "INSERT INTO Project VALUES(:pid,:pname,:pval,:ecost,:mcost,:addcost,:comments,:cs)";
    $stmt = $db->prepare($sql);


    echo $ProjectID;
    $stmt->bindParam(':pid', $ProjectID, SQLITE3_TEXT);
    $stmt->bindParam(':name', $ProjectName, SQLITE3_TEXT);
